...
async function publishTicketPanel(env,guildId){
 ...
 const payload={embeds:[{title:"🎫  Need help?",description:"**Open a private support ticket with our staff.**\n\n• Describe your issue clearly\n• Please avoid opening duplicate tickets\n• A staff member will reply as soon as possible",color:0x7457ff,footer:{text:`${guild?.name||"Discord"} • Support Center`}}],components:[{type:1,components:[{type:2,style:1,label:"Create Support Ticket",emoji:{name:"🎫"},custom_id:`ticket_create:${guildId}`}]}]};
